        ...
        <div className="flex items-center justify-center min-h-screen bg-gray-100 p-4">
            <div className="w-[400px] h-[812px] bg-white rounded-3xl shadow-lg overflow-hidden flex flex-col items-center justify-between py-8 px-6">
                ...
                <div className="relative w-64 h-64">
                    ...
                    ></div>
                    <div 
                        className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-red-500 rounded-full flex items-center justify-center cursor-pointer"
                        style={{ width: '191px', height: '191px' }}
                        onClick={() => router.push('/practice/call')}
                    >
                        <img
