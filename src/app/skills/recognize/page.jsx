  ...
  const handleOptionClick = (option) => {
    ...
    setTimeout(() => {
      ...
      if (nextScenarioId === null) {
        router.push('/skills/recognize/result');
        console.log(
